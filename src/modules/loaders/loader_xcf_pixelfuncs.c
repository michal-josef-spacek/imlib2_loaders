                      ...
                      int dest_w, int dest_h, int dest_x, int dest_y)
{
   ...
   _clip(&src_tl_x, &src_tl_y, &src_br_x, &src_br_y, &dest_x, &dest_y, dest_w,
         dest_h);
   ...
   for (y = src_tl_y; y < src_br_y; y++)
      for (x = src_tl_x; x < src_br_x; x++)
        {
           d_idx =
              LINEAR((dest_x + x - src_tl_x), (dest_y + y - src_tl_y), dest_w);
                     ...
                     do
                       {
                          b--;
                          dest[d_idx + b] =
                             (unsigned char)(src[s_idx + b] * ratio +
                                             dest[d_idx + b] * compl_ratio +
                                             EPS);
                       }
                     while (b);
                  }
